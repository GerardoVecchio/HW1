...
--
-- Host: 127.0.0.1
-- Creato il: Mag 24, 2021 alle 20:57
...
(13, 14.2222, 13.2222, 7.77778, 18),
(14, 17.8889, 5.33333, 4.11111, 18),
(15, 19.7778, 8.11111, 6.44444, 24),
(16, 24, 6.11111, 5.66667, 18),
(17, 21.6667, 5.44444, 5.11111, 18),
(18, 12, 5.88889, 9, 18),
(19, 17.6667, 9.66667, 3.44444, 18),
(20, 20.8889, 9.33333, 5.66667, 18),
(21, 16.5556, 10.4444, 5.77778, 18),
(22, 13.8889, 7.22222, 5.11111, 18),
(23, NULL, NULL, NULL, 0),
(24, NULL, NULL, NULL, 0),
(25, NULL, NULL, NULL, 0),
(26, NULL, NULL, NULL, 0),
...
('BostonCeltics', 'ChicagoBulls', NULL, 12);
...
(14, 'Tacko', 'Fall', 2000000, 1995, 26, 'centro', 'ChicagoBulls', 'https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/3904625.png&w=350&h=254'),
...
(18, 'Rayan', 'Arcidiacono', 6000000, 1994, 27, 'playMaker', 'BostonCeltics', 'https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/4066354.png&w=350&h=254'),
...
--
DELIMITER $$
CREATE TRIGGER `1squadraperallenatore` BEFORE UPDATE ON `squadra` FOR EACH ROW BEGIN
...
--
ALTER TABLE `gestionepartite`
  MODIFY `keyG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT per la tabella `gestionescambi`
--
ALTER TABLE `gestionescambi`
  MODIFY `keyG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
