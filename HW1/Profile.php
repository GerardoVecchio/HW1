...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['accetta'])){
    $chiave=$_POST['chiave'];
    $query_accScambio="CALL updateGestioneScambi('$chiave')";
...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['rifiuta'])){
    $chiave=$_POST['chiave'];
    $query_rifScambio="CALL rifiutaScambio('$chiave')";
                    ...
                    <nav>
                        ...
                        <div id="NavM">
                            <div id="NewSideNav" class="sidenav">
                                ...
                                <a  href="pagina-scambi.php">Scambi</a>
                                <a  href="partite.php">Partite</a>
